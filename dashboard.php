...
// "Files to Rename" / "Files to Validate" are live work-queue counts, not
// "since Reset Dashboard" activity totals — they must match exactly what
// pages/rename_folders.php and pages/validate_folders.php list, or the
// number on the card would disagree with what clicking through shows.
$awaitingRenameCount     = $conn->query("SELECT COUNT(*) FROM documents WHERE status='pending' AND (renamed_filename IS NULL OR renamed_filename = '')")->fetch_row()[0];
$awaitingValidationCount = $conn->query("SELECT COUNT(*) FROM documents WHERE status='pending' AND renamed_filename IS NOT NULL AND renamed_filename != '' AND file_type='pdf'")->fetch_row()[0];
...
<div class="row g-3 mb-4">
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#0f1f3d;" onclick="location.href='pages/users.php'">
  ...
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#1e4db7;" onclick="location.href='pages/reports.php'">
  ...
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#7c3aed;" onclick="location.href='pages/folders.php'">
  ...
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#2196f3;" onclick="location.href='pages/reports.php'">
  ...
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#f39c12;" onclick="location.href='pages/validate_folders.php'">
      <div class="card-icon"><i class="fas fa-clock"></i></div>
      <div class="card-value"><?= $awaitingValidationCount ?></div>
      <div class="card-label">Files to Validate</div>
      <div class="card-change <?= $awaitingValidationCount > 0 ? 'down' : 'up' ?>">
        <i class="fas fa-exclamation-circle"></i>Needs review
      </div>
    </div>
  </div>
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#27ae60;" onclick="location.href='pages/reports.php'">
  ...
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#e74c3c;" onclick="location.href='pages/reports.php'">
  ...
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
    <div class="stat-card" style="cursor:pointer;--card-color:#9b59b6;" onclick="location.href='pages/rename_folders.php'">
      <div class="card-icon"><i class="fas fa-file-signature"></i></div>
      <div class="card-value"><?= $awaitingRenameCount ?></div>
      <div class="card-label">Files to Rename</div>
      <div class="card-change <?= $awaitingRenameCount > 0 ? 'down' : 'up' ?>"><i class="fas fa-tag"></i><?= $awaitingRenameCount > 0 ? 'Needs renaming' : 'All caught up' ?></div>
    </div>
  </div>
</div>
